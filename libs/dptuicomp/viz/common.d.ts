...
/**
 * @deprecated Use SeriesType from 'dptuicomp/common/charts' instead
...
/**
 * @deprecated Use TimeIntervalConfig from 'dptuicomp/common/charts' instead
 * @deprecated Attention! This type is for internal purposes only. If you used it previously, please submit a ticket to our {@link https://supportcenter.dptuiext.com/ticket/create Support Center}. We will check if there is an alternative solution.
 */
export type VizTimeInterval = Common.TimeIntervalConfig;

/**
 * @deprecated Use ScaleBreak from 'dptuicomp/common/charts' instead
 * @deprecated Attention! This type is for internal purposes only. If you used it previously, please submit a ticket to our {@link https://supportcenter.dptuiext.com/ticket/create Support Center}. We will check if there is an alternative solution.
 */
export type ScaleBreak = Common.ScaleBreak;

/**
 * @deprecated Use VisualRange from 'dptuicomp/common/charts' instead
 * @deprecated Attention! This type is for internal purposes only. If you used it previously, please submit a ticket to our {@link https://supportcenter.dptuiext.com/ticket/create Support Center}. We will check if there is an alternative solution.
 */
