...
import dxButton, { Properties } from "dptuicomp/ui/button";
import { IHtmlOptions } from "./core/component";
import type { ClickEvent, ContentReadyEvent, DisposingEvent, InitializedEvent } from "dptuicomp/ui/button";
...
import type * as ButtonTypes from 'dptuicomp/ui/button_types';
export { ButtonTypes };
